...
Original file is located at
    https://colab.research.google.com/drive/1y54iy74UPSYg9Ekf6LqijwP21DuiW_1B
"""
...
path = '/content/drive/MyDrive/textdata.txt'
...
for book in book_files:
  try: books.append(load_book(path+book))
  except : print("Error")
...
with open('/content/drive/MyDrive/textdata.txt') as f:
    lines = f.readlines()
...
values = list("abcçdeəfgğhıijklmnoöpqrsştuüvwxyzABCÇDEƏFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ ")
...
# Clean the text of the books
for i in range (0, len(clean_books)):
  clean_books[i] = remover(clean_books[i])
...
clean_sents_2 = []
for i in range(0, len(clean_books)):
    r = "".join(k for k in clean_books[i] if k.isalnum() or k.isspace())
    result = ''.join([i for i in r if not i.isdigit()])
    text = re.sub(r'[{}@_*>()\\#%+=\[\]]','', result)
    clean_sents_2.append(text)

clean_sents_2 = (clean_sents_2[100:798877] )

len(clean_sents_2)

clean_sents_2 = list(set(clean_sents_2))

clean_sents_2[1:100]

#https://wortschatz.uni-leipzig.de/en/download/Azerbaijani

# Create a dictionary to convert the vocabulary (characters) to integers
vocab_to_int = {}
count = 0
for book in clean_sents_2:
...
training, testing = train_test_split(good_sentences, test_size = 0.30, random_state = 2)
...
letters = ['a','b','c','ç','d','e','ə','f','g','ğ','h','ı','i','j','k','l','m',
...
threshold = 0.9
for sentence in training_sorted[20000:20500]:
    print(sentence)
